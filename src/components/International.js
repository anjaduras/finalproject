    ...
    return (
        <div className='InterBody'>
            ...
            <header className='InterHeader'>
                ...
                <p>Here are some recources for learning German and English sign languages. Enjoy!</p>
            </header>

            <div className='quelle'>
                <Link to="https://www.spreadthesign.com/"><h2>SPREAD THE SIGN</h2></Link>
                <img src={STS} alt="" width={250} />
            ...
            <div className='quelle'>
                ...
                <img src={manimundo} alt="" width={250} />
            ...
            <footer>
                <a href="https://www.instagram.com/tashoklasna/" target="_blank">
